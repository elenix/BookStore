<table width="700px" border="0" align="center" cellpadding="4" cellspacing="0">
    ...
    $no = 1;
    $dte1 = substr($_POST['datestarttxt'],6,4)."-".substr($_POST['datestarttxt'],3,2)."-".substr($_POST['datestarttxt'],0,2);
    $dte2 = substr($_POST['lastdatetxt'],6,4)."-".substr($_POST['lastdatetxt'],3,2)."-".substr($_POST['lastdatetxt'],0,2);
