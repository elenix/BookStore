...
<tr>
<td width="1%" align="left" valign="middle">No Invoice</td>
...
<?php $no++ ; } ?>
<?php
$sql_total = "select sum(sub_total) as gtotal from detail_sale_transactiontbl where detail_sale_transactiontbl.id = '$record[id]'";
