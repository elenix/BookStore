...
<tr>
<td colspan="8" align="right" valign="middle" scope="col"><a href="index.php"><img src="" width="32px" height="32" title="MENU" /></a></td>
</tr>
<tr>
...
<td align="center" scope="col" bgcolor="#FFFFFF"><a href="?go=Detail_Sale&amp;id=<?php echo $record['id']; ?>" title="Detail Sale" target="_self"><img src="" width="15" height="15" /></a>&nbsp;&nbsp;<a onClick="return confirm('You sure want to delete this sale data?');" href="?go=Delete_Sale&amp;id=<?php echo $record['id']; ?>"><img src="" width="15" height="15" /></a></td>
</tr>
<?php $no++; } ?>
</table>
<br />
